    ...
    >
      <nav className="mx-auto flex max-w-6xl items-center justify-between rounded-full border border-white/40 bg-white/40 px-5 py-3 shadow-sm backdrop-blur-lg">
        ...
        <Link
          ...
          onClick={closeMenu}
        >
          <Image src="/android-chrome-192x192.png" alt="Felice Logo" width={32} height={32} className="h-8 w-auto object-contain" priority />
          Felice
        </Link>
        ...
        <span
          ...
          aria-live="polite"
          aria-label="Funcionalidades do Felice"
        >
          {typewriterText}
