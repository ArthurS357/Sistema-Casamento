...
export const metadata: Metadata = {
  title: "Política de Privacidade — Felice",
  description:
    "Como o Felice trata dados de noivos, assessores e convidados em conformidade com a LGPD.",
};
...
export default function PrivacyPage() {
  return (
    <LegalLayout
      ...
      intro="Esta política explica como o Felice coleta, usa, compartilha e protege dados pessoais, em conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018 — LGPD)."
      lastUpdated={LAST_UPDATED}
    >
      <LegalSection title="1. Quem somos e nossos papéis">
        <p>
          O Felice é uma plataforma SaaS de planejamento de casamentos. Para fins da LGPD,
