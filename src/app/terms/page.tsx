...
export const metadata: Metadata = {
  title: "Termos de Uso — Felice",
  description:
    "Condições de uso da plataforma Felice: responsabilidades, assinatura, cancelamento e limitações.",
};
...
export default function TermsPage() {
  return (
    <LegalLayout
      title="Termos de Uso"
      intro="Estes Termos regem o uso da plataforma Felice. Ao criar uma conta ou utilizar o serviço, você concorda com as condições abaixo."
      lastUpdated={LAST_UPDATED}
    >
      <LegalSection title="1. Aceitação dos termos">
        <p>
          Ao se cadastrar ou utilizar o Felice, você declara ter lido e concordado com estes
      ...
      <LegalSection title="2. Descrição do serviço">
        <p>
          O Felice é uma ferramenta de planejamento de casamentos que permite gerenciar lista
      ...
      <LegalSection title="4. Conteúdo do usuário e responsabilidades">
        <p>
          ...
          convidados e informações do evento. Ao usar o Felice, você declara e garante que:
        </p>
        <LegalList
          items={[
            ...
            "É o controlador dos dados dos convidados, sendo o Felice mero operador que age sob sua instrução.",
          ]}
        />
        <p>
      ...
      <LegalSection title="7. Propriedade intelectual">
        <p>
          A plataforma, sua marca, código e design são de titularidade do Felice. Estes Termos
