...
/**
 * Credenciais do Cloudinary lidas no Server Component (sem NEXT_PUBLIC_)
 * e repassadas via props. Sem cloudName/uploadPreset o upload fica off.
 */
 ...
 * cloudName/uploadPreset chegam por props (lidas server-side, sem NEXT_PUBLIC_).
 */
function PhotoManagerCard({
  weddingId, photoUrls, loading, cloudName, uploadPreset,
}: {
  weddingId: string;
  photoUrls: string[];
  loading: boolean;
      ...
      <CardContent>
        ...
        {!configured && (
          <p className="mt-2 text-xs text-amber-600">
            Configure <code>CLOUDINARY_CLOUD_NAME</code> e <code>CLOUDINARY_UPLOAD_PRESET</code> para habilitar o upload.
          </p>
        )}
      </CardContent>
    </Card>
